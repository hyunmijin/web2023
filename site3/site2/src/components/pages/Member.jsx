...
function Member() {
  return (
    <section id="memberSection" className="members__wrap section center">
      <h3>Tatsuya Tanaka</h3>
      <p>다나카 타츠야</p>
      <div className="member__inner container">
        <div className="member">
          <figure className="member__header">
            <img src="./assets/images/member/about01.jpg" alt="" />
          </figure>
        ...
        <div className="member">
          <figure className="member__header">
            <img src="./assets/images/member/about02.jpg" alt="" />
          </figure>
          <div className="member__body">
            <h4 className="title">"</h4>
            <p className="desc">
        ...
        <div className="member">
          <figure className="member__header">
            <img src="./assets/images/member/about03.jpg" alt="" />
          </figure>
          <div className="member__body">
            <h4 className="title">"</h4>
            <p className="desc">
